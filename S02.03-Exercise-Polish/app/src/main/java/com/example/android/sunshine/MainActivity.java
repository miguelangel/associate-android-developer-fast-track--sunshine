...
public class MainActivity extends AppCompatActivity {
    ...
    // DONE (8) Create a method called showWeatherDataView that will hide the error message
    ...
    // DONE (9) Create a method called showErrorMessage that will hide the weather data
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        // DONE (18) Within your AsyncTask, override the method onPreExecute and show the
        //           loading indicator
        @Override
